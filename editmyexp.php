...
<form class="user" method="post" action="">
  <?php
 $empid=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from empexperience where EmpID='$empid'");
$cnt=1;
